  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "serviceType": "Création de site internet à Foix",
      "provider": {
        "@type": "Organization",
        "name": "Webolys",
      ...
      "serviceOutput": "Création de sites internet professionnels pour entreprises et indépendants à Foix.",
      "hasOfferCatalog": {
        "@type": "OfferCatalog",
        "name": "Offres Webolys Foix",
        "itemListElement": [
          {
            "@type": "Offer",
            "itemOffered": { "@type": "Service", "name": "Site vitrine Foix" }
          },
          {
            "@type": "Offer",
          ...
          {
            "@type": "Offer",
            "itemOffered": { "@type": "Service", "name": "SEO local Foix" }
          }
        ]
      }
    }
  ...
  <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "LocalBusiness",
      "@id": "https://webolys.fr/#local-business-foix",
      "name": "Webolys - Création site internet Foix",
      "url": "https://webolys.fr/creation-site-internet-foix.php",
  ...
  <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "WebPage",
      "@id": "https://webolys.fr/creation-site-internet-foix.php#webpage",
      "url": "https://webolys.fr/creation-site-internet-foix.php",
      "name": "Création de site internet à Foix | Webolys",
      "description": "Webolys crée des sites internet professionnels à Foix : site vitrine, e-commerce, SEO local et accompagnement digital sur mesure.",
      "inLanguage": "fr-FR",
      "isPartOf": {
        "@type": "WebSite",
        "url": "https://webolys.fr",
      ...
      "about": {
        "@type": "Thing",
        "name": "Création de site internet à Foix",
        "sameAs": "https://fr.wikipedia.org/wiki/Foix"
      },
      "primaryImageOfPage": {
        "@type": "ImageObject",
      ...
      "breadcrumb": {
        "@id": "https://webolys.fr/creation-site-internet-foix.php#breadcrumb"
      },
      "potentialAction": {
        "@type": "ContactAction",
        "target": "https://webolys.fr/contact.php",
        "name": "Prendre rendez-vous avec Webolys"
      }
    }
  </script>
  <script type="application/ld+json" id="breadcrumb-jsonld">
    {
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 2,
          "name": "Création site internet Foix",
          "item": "https://webolys.fr/creation-site-internet-foix.php"
        }
      ]
    }
  </script>
  <meta name="description" content="Webolys, agence web à Foix : sites vitrines, e-commerce, SEO local et refontes sur mesure pour booster votre visibilité.">
  <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
  <meta name="author" content="Webolys - Agence web à Foix">
  <meta name="publisher" content="Webolys">
  <meta property="og:title" content="Création site internet à Foix | Webolys">
  <meta name="keywords" content="agence web Foix, création site internet Foix, site vitrine Foix, développeur web Foix, SEO local Foix, refonte site internet Foix, Webolys">
  <meta property="og:description" content="Studio web basé à Foix pour artisans, PME et collectivités : design sur-mesure, SEO local et accompagnement de proximité.">
  <meta property="og:site_name" content="Webolys">
  <meta property="og:locale" content="fr_FR">
  <meta property="og:locale:alternate" content="fr_FR">
  <meta property="og:type" content="website">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="Création site internet à Foix | Webolys">
  <meta name="twitter:description" content="Webolys conçoit des sites performants pour les entreprises de Foix et de l'Ariège, avec SEO local et accompagnement dédié.">
  <meta name="twitter:site" content="@webolys">
  <meta name="twitter:creator" content="@webolys">
  <meta name="DC.title" content="Webolys - Création de site internet à Foix">
  <meta name="DC.description" content="Création de site internet sur mesure à Foix : vitrine, e-commerce, SEO local et stratégies digitales pour artisans, PME et institutions.">
...
<body>
  ...
  ?>
  <h1 class="sr-only">Création site internet à Foix - Webolys</h1>
  <main>
    <?php
    ...
    <section id="hero-banner" aria-label="Bannière de présentation de Webolys">
      ...
      <div class="hero-banner-container-text">
        <div class="hero-badge">
          ...
          <span class="badge-text">✨ Créons ensemble votre projet digital à Foix</span>
        </div>
        <h2>
        ...
        <p class="text mask-and-show">
          Code propre, architectures scalables et interfaces intuitives. Je transforme vos besoins en applications web performantes qui propulsent votre croissance 
          et dépassent les attentes de vos utilisateurs. 
        </p>
    ...
    <section class="city-template-value" id="pourquoi-site-internet-city-template" aria-labelledby="city-template-value-title">
      ...
      <div class="city-template-value-header">
        ...
        <h2 id="city-template-value-title">
          Pourquoi créer un <span class="color">site internet</span> à Foix ?
        </h2>
        <p>
          Foix concentre des artisans, PME touristiques et acteurs publics qui cherchent à se démarquer dans tout l'Ariège.
          Un site moderne devient votre vitrine 24/7 : il rassure les habitants, parle aux visiteurs de passage et capte les demandes
          venues de Toulouse ou de l'Andorre voisine. Avec <span class="color">Webolys</span>, vous disposez d'un partenaire local capable d'allier stratégie
          digitale et accompagnement humain pour transformer chaque visiteur en contact qualifié.
        </p>
        <p class="text city-template-value-conclusion-text-bottom">
          Foix compte un tissu économique riche, composé d’artisans, de commerçants, d’hébergements touristiques et d’organismes publics.
          <span class="color">Webolys</span> accompagne les professionnels fuxéens qui souhaitent moderniser leur présence en ligne et attirer davantage de clients
          locaux ou touristiques.
        </p>
        <p class="text city-template-value-conclusion-text-bottom">
          En tant qu’agence web locale, je comprends les enjeux spécifiques du marché ariégeois et je propose des solutions adaptées
          pour maximiser votre visibilité sur Google et convertir les visiteurs en clients fidèles.
        </p>
      </div>
      <div class="city-template-value-grid">
        <article class="service-card local-card" aria-labelledby="city-template-card-visibilite">
          ...
          <h3 id="city-template-card-visibilite" class="service-card-title">Être trouvé par les Fuxéens</h3>
          <p class="service-card-description">
            70% des habitants cherchent une entreprise locale sur Google avant de se déplacer. Un site optimisé SEO local met en avant
            vos services, horaires et avis pour capter ces recherches de proximité.
          </p>
          <ul class="service-card-features">
            <li>Fiches services + FAQ locales</li>
            <li>Balises et données structurées Foix</li>
        ...
        <article class="service-card local-card" aria-labelledby="city-template-card-tourisme">
          ...
          <p class="service-card-description">
            Foix attire chaque année des touristes grâce à son château, ses festivals et ses événements sportifs. Un site bilingue,
            rapide et accessible valorise vos offres, facilite les réservations et rassure les partenaires publics.
          </p>
          <ul class="service-card-features">
        ...
        <article class="service-card local-card" aria-labelledby="city-template-card-growth">
          ...
          <p class="service-card-description">
            Grâce à un site performant hébergé en France, vous pouvez viser Toulouse, Tarbes ou Barcelone tout en conservant votre ADN
            local. Automatisations, newsletters et analytics permettent de suivre précisément votre croissance.
          </p>
          <ul class="service-card-features">
