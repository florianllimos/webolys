  ...
  <main class="container-rgpd">
    ...
    <section class="privacy-policy" role="document" aria-labelledby="privacy-title">
      <div class="container">
        ...
        <p>
          Pour exercer vos droits, vous pouvez nous contacter à l’adresse suivante : <strong>contact@webolys.fr</strong> ou par courrier à l’adresse suivante : <strong>1 avenue du Scios, 09000 Saint Paul de Jarrat, France</strong>.
        </p>
