...
<head>
  ...
  <script type="application/ld+json">
    {
      ...
      "@type": "Service",
      "serviceType": "Création de site internet à Lavelanet",
      "provider": {
        "@type": "Organization",
        "name": "Webolys",
      ...
      "hasOfferCatalog": {
        ...
        "itemListElement": [
          ...
          {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Boutique en ligne Lavelanet"}},
          {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "Refonte site internet Lavelanet"}},
          {"@type": "Offer", "itemOffered": {"@type": "Service", "name": "SEO local Lavelanet"}}
        ]
      }
    }
  </script>
  ...
  <script type="application/ld+json">
    {
      ...
      "about": {
        "@type": "Thing",
        "name": "Création de site internet à Lavelanet",
        "sameAs": "https://fr.wikipedia.org/wiki/Lavelanet"
      },
      "breadcrumb": {
      ...
      "potentialAction": {
        ...
        "name": "Discuter d'un projet web à Lavelanet"
      }
    }
  </script>
  ...
  <meta name="description" content="Webolys, agence web à Lavelanet : sites vitrines, e-commerce, SEO local et refontes sur mesure pour booster votre visibilité.">
  <meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1">
  <meta name="author" content="Webolys - Agence web à Lavelanet">
  <meta name="publisher" content="Webolys">
  <meta property="og:title" content="Création site internet à Lavelanet | Webolys">
  <meta name="keywords" content="agence web Lavelanet, création site internet Lavelanet, site vitrine Lavelanet, développeur web Lavelanet, SEO local Lavelanet, refonte site internet Lavelanet, Webolys">
  <meta property="og:description" content="Studio web basé à Lavelanet pour artisans, PME et collectivités : design sur-mesure, SEO local et accompagnement de proximité.">
  ...
  <meta name="twitter:description" content="Webolys conçoit des sites performants pour les entreprises de Lavelanet, avec SEO local et accompagnement dédié.">
  <meta name="twitter:site" content="@webolys">
  <meta name="twitter:creator" content="@webolys">
  <meta name="DC.title" content="Webolys - Création de site internet à Lavelanet">
  <meta name="DC.description" content="Création de site internet sur mesure à Lavelanet : site vitrine, e-commerce, SEO local et stratégies digitales pour entreprises et institutions.">
...
<body>
  ...
  ?>
  <h1 class="sr-only">Création site internet à Lavelanet - Webolys</h1>
  <main>
    <?php
    ...
    <section id="hero-banner" aria-label="Bannière de présentation de Webolys">
      ...
      <div class="hero-banner-container-text">
        <div class="hero-badge">
          ...
          <span class="badge-text">✨ Créons ensemble votre projet digital à Lavelanet</span>
        </div>
        <h2>
    ...
    <section class="city-template-value" id="pourquoi-site-internet-city-template" aria-labelledby="city-template-value-title">
      ...
      <div class="city-template-value-header">
        ...
        <h2 id="city-template-value-title">
          Pourquoi créer un <span class="color">site internet</span> à Lavelanet ?
        </h2>
        <p>
          Lavelanet est une ville en pleine transformation, située au cœur du Pays d’Olmes, 
          entre Foix, Mirepoix et les contreforts pyrénéens. Avec un tissu économique varié, 
          une dynamique culturelle forte et un territoire touristique marqué par Montségur et 
          les vallées voisines, un site internet professionnel est indispensable pour se démarquer 
          et attirer davantage de clients. Webolys accompagne les entrepreneurs lavelanétiens dans 
          la création de sites modernes, rapides et optimisés pour Google.
        </p>
        <p class="text city-template-value-conclusion-text-bottom">
          Lavelanet réunit artisans, commerçants, associations, entreprises industrielles, services à la personne, 
          acteurs touristiques et indépendants. Un site clair et bien structuré permet de présenter vos prestations, 
          renforcer votre crédibilité et capter aussi bien les habitants que les visiteurs de passage.
        </p>
        <p class="text city-template-value-conclusion-text-bottom">
          Basé en Ariège, Webolys crée des sites adaptés au marché local : performants, sécurisés, accessibles et optimisés 
          pour le référencement, pour aider les professionnels lavelanétiens à développer leur visibilité.
        </p>
      </div>
      <div class="city-template-value-grid">
        <article class="service-card local-card" aria-labelledby="city-template-card-visibilite">
          ...
          <h3 id="city-template-card-visibilite" class="service-card-title">Être trouvé par les Lavelanétiens</h3>
          <p class="service-card-description">
            Les habitants de Lavelanet recherchent de plus en plus artisans, commerces, restaurants et services sur Google. 
            Un site bien optimisé vous permet d’apparaître dans les recherches ciblant Lavelanet, Villeneuve-d’Olmes, Laroque-d’Olmes, 
            Montferrier, Dreuilhe, Bélesta et plus largement le Pays d’Olmes. Vous captez ainsi les clients locaux avant vos concurrents.
          </p>
          <ul class="service-card-features">
            <li>SEO local Lavelanet + communes alentours</li>
            <li>Balises & données structurées pour la visibilité locale</li>
        ...
        <article class="service-card local-card" aria-labelledby="city-template-card-tourisme">
          ...
          <h3 id="city-template-card-tourisme" class="service-card-title">Mettre en valeur votre activité</h3>
          <p class="service-card-description">
            Un site internet professionnel permet de présenter clairement vos services, vos réalisations et vos valeurs. 
            Que vous soyez artisan, commerçant, thérapeute, restaurateur, guide touristique ou indépendant, votre site 
            rassure les visiteurs et facilite la prise de contact ou la demande de devis.
          </p>
          <ul class="service-card-features">
            <li>Pages dédiées à vos services</li>
            <li>Formulaire de contact ou prise de rendez-vous</li>
            <li>Design moderne et adapté aux mobiles</li>
          </ul>
        </article>
        <article class="service-card local-card" aria-labelledby="city-template-card-growth">
          ...
          <h3 id="city-template-card-growth" class="service-card-title">Booster votre visibilité dans le Pays d’Olmes</h3>
          <p class="service-card-description">
            Grâce à un site performant, vous touchez non seulement Lavelanet, mais aussi tout le Pays d’Olmes, Foix, Pamiers, 
            Mirepoix et même la clientèle touristique se rendant à Montségur ou dans les Pyrénées. Avec des outils marketing 
            modernes, vous développez votre visibilité et suivez facilement les performances de votre site.
          </p>
          <ul class="service-card-features">
            <li>Pages optimisées par zone géographique</li>
            <li>Connexion CRM & outils marketing</li>
            <li>Statistiques complètes pour suivre votre croissance</li>
          </ul>
        </article>
      </div>
    </section>
