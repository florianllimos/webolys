...
<body>
  ...
  <main id="main-content" class="container-service-page">
      ...
      <div class="container">
        <div class="intro-content">
          <div class="intro-text">
            ...
            <p>
              Chez <span class="color"><strong>Webolys</strong></span>, je crée des sites WordPress entièrement personnalisés, 
              optimisés pour le référencement et conçus pour évoluer avec votre activité. Vous bénéficiez d'un site professionnel, 
              facile à gérer et performant.
            </p>
          </div>
          <div class="intro-stats">
            <div class="stat-card">
              <div class="stat-number">43%</div>
              <div class="stat-label">Des sites web utilisent WordPress</div>
            </div>
            <div class="stat-card">
    ...
    <!-- Process Section -->
    <section class="container-processus" role="region" aria-labelledby="processus-heading-wp">
      ...
      <div class="processus-header">
        <h2 id="processus-heading-wp" class="section-title">
        ...
        <div class="processus-steps">
          <article class="processus-step" data-step="1">
            ...
            <div class="step-content">
              ...
              <p>
                Échange approfondi pour comprendre vos objectifs, votre cible et vos contraintes. 
                Définition du cahier des charges et du périmètre fonctionnel WordPress.
              </p>
            </div>
          </article>
          ...
          <article class="processus-step" data-step="2">
            ...
            <div class="step-content">
              ...
              <p>
                Création de maquettes graphiques personnalisées reflétant votre identité. 
          ...
          <article class="processus-step" data-step="3">
            ...
            <div class="step-content">
              ...
              <p>
                Installation et configuration de WordPress, développement du thème personnalisé, 
                intégration des plugins nécessaires et création du contenu.
              </p>
            </div>
          </article>
          ...
          <article class="processus-step" data-step="4">
            ...
            <div class="step-content">
              ...
              <p>
                Tests complets sur tous les navigateurs et appareils, optimisation des performances, 
                sécurisation et configuration SEO.
              </p>
            </div>
          </article>
          ...
          <article class="processus-step" data-step="5">
            ...
            <div class="step-content">
              ...
              <p>
                Formation à l'administration de votre site WordPress, mise en ligne et accompagnement 
                post-lancement pour assurer votre autonomie.
              </p>
            </div>
          </article>
        </div>
