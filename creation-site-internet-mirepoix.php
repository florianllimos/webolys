      ...
      <div class="city-template-value-grid">
        <article class="service-card local-card" aria-labelledby="city-template-card-visibilite">
          ...
          <p class="service-card-description">
            ...
            activités sur Google. Un site optimisé SEO local vous permet d’apparaître dans les recherches ciblant Mirepoix, 
            Roumengoux, Lagarde, Camon, Moulin-Neuf ou les villages de la vallée de l’Hers. Vous captez ainsi les demandes 
            locales avant vos concurrents.
          </p>
        ...
        <article class="service-card local-card" aria-labelledby="city-template-card-tourisme">
          ...
          <p class="service-card-description">
            ...
            les réservations et renforce votre crédibilité auprès des touristes, offices de tourisme, associations 
        ...
        <article class="service-card local-card" aria-labelledby="city-template-card-growth">
          ...
          <p class="service-card-description">
            ...
            vous suivez vos performances et développez votre activité au-delà de la cité médiévale.
          </p>
          <ul class="service-card-features">
